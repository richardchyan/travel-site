...
const Carousel = () => {
  return (
         <div id="default-carousel" class="relative max-w-screen-xl px-8 m-auto" data-carousel="static">
         {/* <!-- Carousel wrapper --> */}
         <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
            ...
            {/* Item 4 */}
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
               <img src={img7} class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
            </div>
            {/* Item 5 */}
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
               <img src={img9} class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
            </div>
         </div>
         {/* <!-- Slider indicators --> */}
